...
- name the post like: **µOS++ device-qemu-cortexm v3.0.0 released**
...
- `npm dist-tag add @micro-os-plus/devices-qemu-cortexm@3.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/devices-qemu-cortexm`
...
- paste the release name like **µOS++ device-qemu-cortexm v3.0.0 released**
